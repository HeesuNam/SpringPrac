package com.example.springprac2.mvc;

import com.example.springprac2.Dto.ProductRequestDto;
import com.example.springprac2.controller.ProductController;
import com.example.springprac2.controller.UserController;
...
import com.example.springprac2.security.WebSecurityConfig;
import com.example.springprac2.service.KakaoUserService;
...
@WebMvcTest(controllers = { UserController.class, ProductController.class }, excludeFilters = {
...
class UserProductMvcTest {
    ...
    void test2() throws Exception {
        ...
        signupRequestForm.add("username", "유저");
        signupRequestForm.add("password", "user!@#");
        signupRequestForm.add("email", "user@gmail.com");
